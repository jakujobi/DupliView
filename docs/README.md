...
- [First Scan](guides/first-scan.md): run a small scan and find the CSV report.
- [Network Drive Scan](guides/network-drive-scan.md): scan `L:\` or a shared path such as `\\server\share`.
...
DupliView does not delete, move, rename, overwrite, upload, or modify scanned files. The docs should stay inside that same boundary.
